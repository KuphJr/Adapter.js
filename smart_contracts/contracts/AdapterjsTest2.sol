...
contract AdapterjsTest2 is ChainlinkClient {
  ...
  function boolAdapterCall(address _oracle, string memory _jobId, uint _payment, string memory _type,
  ...
  function uintAdapterCall(address _oracle, string memory _jobId, uint _payment, string memory _type,
    string memory _js, string memory _vars, string memory _cid, string memory _ref)
    public returns (bytes32 requestId) {
      Chainlink.Request memory request;
  ...
  function intAdapterCall(address _oracle, string memory _jobId, uint _payment, string memory _type,
    string memory _js, string memory _vars, string memory _cid, string memory _ref)
    public returns (bytes32 requestId) {
      Chainlink.Request memory request;
  ...
  function bytes32AdapterCall(address _oracle, string memory _jobId, uint _payment, string memory _type,
    string memory _js, string memory _vars, string memory _cid, string memory _ref)
    public returns (bytes32 requestId) {
      Chainlink.Request memory request;
  ...
  function stringAdapterCall(address _oracle, string memory _jobId, uint _payment, string memory _type,
    string memory _js, string memory _vars, string memory _cid, string memory _ref)
    public returns (bytes32 requestId) {
      Chainlink.Request memory request;
  ...
  function bytesAdapterCall(address _oracle, string memory _jobId, uint _payment, string memory _type,
    string memory _js, string memory _vars, string memory _cid, string memory _ref)
    public returns (bytes32 requestId) {
      Chainlink.Request memory request;
